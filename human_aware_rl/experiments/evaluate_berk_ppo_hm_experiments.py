...
def run_all_ppo_hm_experiments(best_bc_model_paths):
    ...
    ppo_hm_model_paths = {
        ...
        "random0": "2021_07_23-09_56_16_ppo_hm_random0"
    }
    ...
    set_global_seed(124)
    num_rounds = 50
    ppo_hm_performance = evaluate_all_ppo_hm_models(ppo_hm_model_paths, best_bc_model_paths['test'], num_rounds, seeds, best=False)
    print('ppo_hm_performance', ppo_hm_performance)
