...
def visualize_fixed_trial(a0_type, a1_type, title="FC: DP vs. DP Players", video_filename='my_video'):
...
if __name__ == "__main__":
    visualize_fixed_trial('DP', 'DP', title="FC: DP vs. DP Players", video_filename='dp_dp_video_2')
    visualize_fixed_trial('SP', 'SP', title="FC: SP vs. SP Players", video_filename='sp_sp_video_2')
    visualize_fixed_trial('DP', 'SP', title="FC: SP vs. DP Players", video_filename='dp_sp_video_2')
    visualize_fixed_trial('SP', 'DP', title="FC: DP vs. SP Players", video_filename='sp_dp_video_2')
