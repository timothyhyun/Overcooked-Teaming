...
if __name__ == '__main__':
    ...
    # Try N=4 Clusters
    cluster_labels, cluster_centers = cluster_hidden_states(hidden_seqs, n_clusters=4)
    print(f'\nN=4: cluster_labels = {cluster_labels}, teams = {team_numbers}')

    # Try N=5 Clusters
    cluster_labels, cluster_centers = cluster_hidden_states(hidden_seqs, n_clusters=5)
    print(f'\nN=3: cluster_labels = {cluster_labels}, teams = {team_numbers}')
