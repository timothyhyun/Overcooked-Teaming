...
def run_two_ppo_models_for_layout(layout, num_rounds, ppo_bc_model_paths, bc_model_paths, seeds, best=False,
    ...
    for train_seed_idx in range(len(seeds["bc_train"])):
        for test_seed_idx in range(len(seeds["bc_test"])):
            ...
            avg_ppo_and_ppo = np.mean(ppo_and_ppo['ep_returns'])
            ppo_ppo_performance[layout]["PPO_BC_train+PPO_BC_train_MEAN"].append(avg_ppo_and_ppo)
            ppo_ppo_performance[layout]["PPO_BC_train+PPO_BC_train_STD"].append(np.std(ppo_and_ppo['ep_returns']))
            ...
            avg_ppo_and_ppo = np.mean(ppo_and_ppo['ep_returns'])
            ppo_ppo_performance[layout]["PPO_BC_test+PPO_BC_test_MEAN"].append(avg_ppo_and_ppo)
            ppo_ppo_performance[layout]["PPO_BC_test+PPO_BC_test_STD"].append(np.std(ppo_and_ppo['ep_returns']))
            ...
            ppo_and_ppo = evaluator.evaluate_agent_pair(
                ...
                num_games=original_num_games, display=display)
            avg_ppo_and_ppo = np.mean(ppo_and_ppo['ep_returns'])
            ppo_ppo_performance[layout]["PPO_BC_train+PPO_BC_test_MEAN"].append(avg_ppo_and_ppo)
            ppo_ppo_performance[layout]["PPO_BC_train+PPO_BC_test_STD"].append(np.std(ppo_and_ppo['ep_returns']))
            ...
            ppo_and_ppo = evaluator.evaluate_agent_pair(
                ...
                num_games=original_num_games, display=display)
            avg_ppo_and_ppo = np.mean(ppo_and_ppo['ep_returns'])
            ppo_ppo_performance[layout]["PPO_BC_test+PPO_BC_train_MEAN"].append(avg_ppo_and_ppo)
            ppo_ppo_performance[layout]["PPO_BC_test+PPO_BC_train_STD"].append(np.std(ppo_and_ppo['ep_returns']))
...
def run_two_ppo_agents(seeds, num_rounds = 20):
    reset_tf()
    ...
    ppo_bc_model_paths = {
        'bc_train': {
            ...
            # "random0": "2021_11_17-10_27_36_h_proxy_SPstrat_7rew_weights_ppo_bc_train_random0_test1",
            # "random0": "2021_11_22-13_18_08_h_proxy_DPstrat_6rew_downweightbothpots_weights_ppo_bc_train_random0_test2",
        ...
        'bc_test': {
            ...
            # "random0": "2021_11_17-11_36_04_h_proxy_DPstrat_7rew_weights_ppo_bc_train_random0_test1",
            # "random0": "2021_11_17-11_36_44_h_proxy_DPstrat_6rew_weights_ppo_bc_train_random0_test1",
            # "random0":"2021_11_22-14_25_42_h_proxy_DPstrat_7rew_handtuned_ppo_bc_train_random0_test2",
...
if __name__ == "__main__":
    ...
    data = ppo_results['random0']
    # run_two_bc_agents()
    for keyname in ["PPO_BC_train+PPO_BC_train", "PPO_BC_test+PPO_BC_test", "PPO_BC_train+PPO_BC_test", "PPO_BC_test+PPO_BC_train"]:
