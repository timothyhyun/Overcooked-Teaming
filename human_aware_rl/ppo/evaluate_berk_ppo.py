...
PPO_DATA_DIR = '../experiments/results_forte2/data/ppo_runs/'
...
def get_params_test_exp_1_config():
    ...
    TIMESTAMP_DIR = True
    EX_NAME = "testing_ppo_bc_train_fc_1_random0"
...
def get_rollouts_from_match_ppo_with_other_agent(save_dir, other_agent, params, n=1, seed=0, display=False):
    agent, agent_eval = get_ppo_agent(save_dir, seed=seed)
...
def test_ppo_agent(params):
    ...
    save_dir = 'ppo_bc_train_random0'
    a_self_play, a_config = get_ppo_agent(save_dir, seed=1887, best=False)
    rollouts1, rollouts2 = get_rollouts_from_match_ppo_with_other_agent(save_dir, a_self_play, params, n=4, seed=1887, display=False)
...
def test_bc_ppo_agent():
    ...
    model_name = 'orig_berk_random0_bc_test_seed2'
    ...
    for seed_no in [9456, 1887, 5578, 5987,  516]:
        print('seed_no', seed_no)
        rollouts1, rollouts2 = get_rollouts_from_match_ppo_with_other_agent(save_dir, a_self_play, bc_params, n=100, seed=seed_no, display=False)
        pickle.dump(rollouts1, open(f'rollout_trajs/bc_ppo_seed{seed_no}_n{100}_rollouts1.pkl', 'wb'))
        pickle.dump(rollouts2, open(f'rollout_trajs/bc_ppo_seed{seed_no}_n{100}_rollouts2.pkl', 'wb'))
    # print('rollouts1', rollouts1)
    # print()
    # print('rollouts2', rollouts2)
    return rollouts1, rollouts2
