...
def featurize_data_for_naive_hmm(window=4, ss=3):
...
#
#
#     test_unsuper_hmm, hidden_seqs, team_numbers = run_naive_hmm_on_p2(n_states = 3)
#
#     # Try N=2 Clusters
...
#     print('N=2, sil. score = ', ss)
#
#     # Try N=3 Clusters
#     cluster_labels, cluster_centers, ss = cluster_hidden_states(hidden_seqs, n_clusters=3)
#     print(f'\nN=3: cluster_labels = {cluster_labels}, teams = {team_numbers}')
#     print('N=3, sil. score = ', ss)
#
