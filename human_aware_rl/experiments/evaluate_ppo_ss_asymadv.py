...
def play_ppo_vs_ppo(num_games, p1_file, p2_file):
    ...
    bc_model_path_for_loading = 'aa_strat3_finetune_unident_s_bc_test_seed5415'
...
def run_all_evaluation_combinations(num_games = 100):
    model_files_dict = {
        'PPO - Strat3': '2021_08_22-21_25_44_aa_strat3_ppo_bc_train_random3',
        'PPO - Strat2': '2021_08_22-21_25_20_aa_strat2_ppo_bc_train_random3',
        'PPO - Strat1': '2021_08_22-21_24_40_aa_strat1_ppo_bc_train_random3',
        'PPO - Strat0': '2021_08_22-21_23_45_aa_strat0_ppo_bc_train_random3',
        'PPO - Test': '2021_08_23-15_11_50_aa_strat3_ppo_bc_test_random3',
        'BC - Train(Strat3)': 'aa_strat3_finetune_unident_s_bc_train_seed5415',
        'BC - Train(Strat2)': 'aa_strat2_finetune_unident_s_bc_train_seed5415',
        'BC - Train(Strat1)': 'aa_strat1_finetune_unident_s_bc_train_seed5415',
        'BC - Train(Strat0)': 'aa_strat0_finetune_unident_s_bc_train_seed5415',
        'BC - Test': 'aa_strat3_finetune_unident_s_bc_test_seed5415',
    }
    ...
    for agent_name_p1 in ['BC - Test']:
        with open('asym_adv_compare_outcome_dict2.pickle', 'wb') as handle:
        ...
        for agent_name_p2 in model_files_dict:
            ...
            if "PPO" in agent_name_p1 and "PPO" in agent_name_p2:
                ...
                print(outcome_key, (mean_reward, std_reward))
    ...
    print('AA outcome_dict = ', outcome_dict)
    return outcome_dict
...
if __name__ == "__main__":
    ...
    with open('asym_adv_compare_outcome_dict2.pickle', 'rb') as handle:
        outcome = pickle.load(handle)

    for outcome_key in outcome:
        if 'BC - Test' in outcome_key:
            print(outcome_key, outcome[outcome_key])
    # print(outcome)
    with open('aa_outcome2.txt', 'w') as f:
