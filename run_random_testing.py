...
#     }
    data = {
        ...
        'PPO_BC_train+BC_test_0': [51.6, 55.0, 69.0, 61.0, 65.8],
        'PPO_BC_train+BC_test_1': [78.6, 96.6, 63.2, 84.8, 90.2],
        'PPO_BC_test+BC_test_0': [56.4, 51.2, 49.4, 73.2, 72.2], 'PPO_BC_test+BC_test_1': [91.6, 92.0, 90.6, 88.6, 89.6]
        }
